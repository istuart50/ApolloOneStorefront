const products = [
    ...
    },
    {
        ...
        description: 'This hidden hair knife is for those of yiou who are seeking to be covert. They are best used from a distance, if you see a man approaching and he looks sleazy, do NOT be afraid to go for it!',
        cost: '$9.99'
    },
    {
        id: 'lipstickGun',
...
products.forEach((product, idx) => {
    ...
    const cardContent = `
        <img src="${product.image}" class="card-img-top" alt="Mace">
        <div class="card-body product-card-body">
            ...
            <a href="#" class="btn btn-primary product-card-button">Add to Cart</a>
        </div>
    `;
